...
export default function Nav() {
  ...
  return (
    <ContentWrapper element="nav" className="fixed z-[100] left-1/2 top-5 mx-auto w-full max-w-[690px] -translate-x-1/2">
      <div
        className={twMerge(
        ...
        <div
          className={twMerge(
            "absolute left-0 top-[130%] w-full flex-col items-center justify-evenly gap-4 rounded-3xl bg-zinc-50 py-6 text-sm font-medium  shadow-md shadow-black/20 lg:relative lg:top-0 lg:flex lg:flex-row lg:justify-end lg:gap-10 lg:bg-transparent lg:py-0 lg:shadow-none",
            expand ? "flex" : "hidden",
          )}>
